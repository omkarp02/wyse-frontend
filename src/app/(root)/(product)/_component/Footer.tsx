  ...
  return (
    <footer className="bg-[#1e2a5a] text-white py-6 px-4 md:px-8 lg:px-16">
      ...
      <div className="hidden md:grid md:grid-cols-4 gap-8 mb-8">
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li>
              <Link href="/classic-tees" className="hover:underline">
                Classic Tees
              </Link>
            </li>
            <li>
              <Link href="/oversized-tees" className="hover:underline">
                Oversized Tees
              </Link>
            </li>
            <li>
              <Link href="/travel-jogger" className="hover:underline">
                Travel Jogger
              </Link>
            </li>
            <li>
              <Link href="/fashion-joggers" className="hover:underline">
                Fashion Joggers
              </Link>
            </li>
            <li>
              <Link href="/hoodies" className="hover:underline">
                Hoodies
              </Link>
            </li>
          </ul>
          ...
          >
            ...
            <svg
              ...
              className={`h-4 w-4 transition-transform ${
                openSection === "categories" ? "transform rotate-180" : ""
              }`}
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
        ...
        <div className="border-t border-white border-opacity-20 py-3">
          ...
          >
            ...
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className={`h-4 w-4 transition-transform ${
                openSection === "help" ? "transform rotate-180" : ""
              }`}
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
      ...
      <div className="mt-8 pt-4 border-t border-white border-opacity-20 text-sm text-center md:text-left">
        © 2025 Prototype Website — This site is for demonstration purposes only.
